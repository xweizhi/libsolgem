...
class TSolGEMVStrip {
 ...
 private:
  ...
  struct VStrips
  {
    ...
    std::vector<Double_t> fADC;     // value of the ADC sample 
 ...
 public:
  ...
  void AddSampleAt(Double_t val, Short_t sample, Short_t n) {fVStrips.at(n)->fADC.at(sample)=val;}
  ...
  Double_t GetADC(Short_t n, Short_t sample) const { return fVStrips.at(n)->fADC.at(sample); }
